...
import br.com.evandro.gestao_vagas.modules.candidate.DTO.AuthCandidateRequestDTO;
import br.com.evandro.gestao_vagas.modules.candidate.DTO.AuthCandidateResponseDTO;
...
public class AuthCandidateUseCase {
    ...
    public AuthCandidateResponseDTO execute(AuthCandidateRequestDTO authCandidateRequestDTO) throws AuthenticationException {
        ...
        var passwordMathces = passwordEncoder.matches(authCandidateRequestDTO.password(), candidate.getPassword());
        if(!passwordMathces){
